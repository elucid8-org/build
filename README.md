...
<span style="font-weight: 600; font-style: italic">3.&nbsp;landing-page</span>
...
2. glue web pages must be generated after all content sources  

3. glue pages must be rendered in an explicit order  

4. if no content sources have changed since the last rendering, then glue web pages do not need to be re-generated, unless a glue source has itself been modified.  
