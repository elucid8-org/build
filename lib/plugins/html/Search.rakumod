...
unit class Elucid8::Plugin::HTML::Search;
has %.config =
    :name-space<Search>,
	:version<0.1.0>,
    ...
    ui-tokens => %(
        ...
        :options-search-extra-on<on>,
        :options-search-extra-off<off>,
        ...
        :options-search-composite-on<on>,
        :options-search-composite-off<off>,
        :options-search-primary<Primary>,
        :options-search-primary-tip('Search through the names of the main web pages'),
        :options-search-primary-on<on>,
        :options-search-primary-off<off>,
...
method prepare-search-data( $rdp, $lang, $to ) {
...
method search-scss{
    ...
    .autoComplete_options .autoComplete_wrapper {
        > input {
